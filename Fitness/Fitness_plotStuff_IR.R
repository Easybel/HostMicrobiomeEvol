...
path="/home/isabel/Documents/postDoc_Amsterdam/1_EvolWormJourney/2_Fitness/1_RawData_fromThomas/"
...
hist(repeatability$growth_nematode_m, breaks = 25)
boxplot(data = repeatability, growth_nematode_m ~ lab)
