...
#samtools mpileup -f $myIdxPath/$ref_index".fasta" $BamList -o /scratch/$IDnameOut".mpileup"
...
#3. do the sync
## python version
perl $myPopPath/mpileup2sync.pl --fastq-type sanger --min-qual 20 --input /scratch/$IDnameOut".mpileup" --output /scratch/$IDnameOut".mpileup_minQUAL20.sync"
