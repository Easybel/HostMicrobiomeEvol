...
SamName=$(ls -1 $pilePath | grep "VU_bn50_15_1\|VU_bn50_15_2\|VU_bn50_15_3\|VU_bn50_15_4\|VU_bn50_15_5\|VU_bn5_0_5\|VU_bn5_15_1\|VU_bn5_15_2\|VU_bn5_15_3\|VU_bn5_15_4\|VU_bn5_15_5" | sed -n ''$i'p' | cut -d"_" -f1,2,3,4)

#SamName=$(grep $SamNameList | sed -n ''$i 'p')
