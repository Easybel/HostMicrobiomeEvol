...
#2a. Make Bamlist
#BamList="$myBamPath/Gent_iso_15_1_CE_mapped_compl.bam \
#$myBamPath/Gent_iso_15_2_CE_mapped_compl.bam \
#$myBamPath/Gent_iso_15_3_CE_mapped_compl.bam \
#$myBamPath/Gent_iso_15_4_CE_mapped_compl.bam \
#$myBamPath/WUR_bleach_15_1_CE_mapped_compl.bam \
#$myBamPath/WUR_bleach_15_2_CE_mapped_compl.bam"
