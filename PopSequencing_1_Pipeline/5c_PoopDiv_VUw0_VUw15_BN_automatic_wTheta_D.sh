...
#SBATCH --mem-per-cpu=1GB  # Adjust this based on your memory requirements
#SBATCH --array=1-20%6
i=$SLURM_ARRAY_TASK_ID

# paths!
pilePath="/zfs/omics/projects/cevolution/CE_mapped/pileup"
outPath="/zfs/omics/projects/cevolution/PopAnalysis_IR/Popoolation/Pi_Diversity/defaultSettings_Sanger500Cov"
...
perl $popoPath1/Variance-sliding.pl --input /scratch/easy/$SamName"_temp.pileup" --output $outPath/$SamName"_Sanger_maxCov500.pi" --fastq-type sanger --measure pi --window-size 10000 --step-size 10000 --min-count 2 --min-coverage 4 --max-coverage 500 --min-qual 20 --pool-size 500

perl $popoPath1/Variance-sliding.pl --input /scratch/easy/$SamName"_temp.pileup" --output $outPath/$SamName"_Sanger_maxCov500.theta" --fastq-type sanger --measure theta --window-size 10000 --step-size 10000 --min-count 2 --min-coverage 4 --max-coverage 500 --min-qual 20 --pool-size 500

perl $popoPath1/Variance-sliding.pl --input /scratch/easy/$SamName"_temp.pileup" --output $outPath/$SamName"_Sanger_maxCov500.D" --fastq-type sanger --measure D --window-size 10000 --step-size 10000 --min-count 2 --min-coverage 4 --max-coverage 500 --min-qual 20 --pool-size 500
