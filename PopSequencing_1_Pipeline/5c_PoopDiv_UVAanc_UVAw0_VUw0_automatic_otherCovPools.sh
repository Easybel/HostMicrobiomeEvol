...
pilePath="/zfs/omics/projects/ecolievo/irathma/pileup_temp"
outPath="/zfs/omics/projects/cevolution/PopAnalysis_IR/Popoolation/Pi_Diversity/defaultSet_MultiCov_Pool"
...
perl $popoPath1/Variance-sliding.pl --input $pilePath/$SamName"_temp.pileup" --output $outPath/$SamName"_Sanger_maxCov500_Pool100.pi" --fastq-type sanger --measure pi --window-size 10000 --step-size 10000 --min-count 2 --min-coverage 4 --max-coverage 500 --min-qual 20 --pool-size 100

perl $popoPath1/Variance-sliding.pl --input $pilePath/$SamName"_temp.pileup" --output $outPath/$SamName"_Sanger_maxCov500_Pool1000.pi" --fastq-type sanger --measure pi --window-size 10000 --step-size 10000 --min-count 2 --min-coverage 4 --max-coverage 500 --min-qual 20 --pool-size 1000

perl $popoPath1/Variance-sliding.pl --input $pilePath/$SamName"_temp.pileup" --output $outPath/$SamName"_Sanger_maxCov800_Pool500.pi" --fastq-type sanger --measure pi --window-size 10000 --step-size 10000 --min-count 2 --min-coverage 4 --max-coverage 800 --min-qual 20 --pool-size 500
